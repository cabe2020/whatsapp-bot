...
exports.info = info()
function snk() {
    return `Términos y Condiciones *CABE BOT*
    ...
    6. Sea lo que sea que pidas en este bot, ¡NO SEREMOS RESPONSABLES!
    ¡Gracias!`
}
exports.snk = snk()
function sewa() {
...
╠➥ *5. PUEDE ALQUILAR LOS BOTS ATRÁS*
╠═══════════════════════════
╠➥ *SI INTERESES PUBLICITARIOS*
╠➥ *POR FAVOR LLAME AL NÚMERO DE ABAJO :*
╠➥ *wa.me/543757437404*
║
╚═〘 CABE BOT 〙
`
