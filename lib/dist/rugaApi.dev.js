...
var fb = function fb(url) {
  return regeneratorRuntime.async(function fb$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", new Promise(function (resolve, reject) {
            axios.get("".concat(link, "/api/fb?url=").concat(url)).then(function (res) {
              if (res.data.error) resolve({
                status: 'error',
...
var ytmp3 = function ytmp3(url) {
  return regeneratorRuntime.async(function ytmp3$(_context4) {
    while (1) {
...
var ytmp4 = function ytmp4(url) {
  return regeneratorRuntime.async(function ytmp4$(_context5) {
    while (1) {
...
var stalkig = function stalkig(url) {
  return regeneratorRuntime.async(function stalkig$(_context6) {
    while (1) {
...
var stalkigpict = function stalkigpict(url) {
  return regeneratorRuntime.async(function stalkigpict$(_context7) {
    while (1) {
...
var quote = function quote() {
  return regeneratorRuntime.async(function quote$(_context8) {
    while (1) {
...
var cersex = function cersex() {
  return regeneratorRuntime.async(function cersex$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        case 0:
          return _context14.abrupt("return", new Promise(function (resolve, reject) {
            var ransex = Math.floor(Math.random() * 2) + 1;
            axios.get("".concat(link, "/api/cersex").concat(ransex)).then(function (res) {
              resolve(res.data);
            })["catch"](function (err) {
              reject(err);
            });
